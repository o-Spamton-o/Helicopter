...
function checkCollisions() {
  ...
  if (
    heli.x + heli.w >= wall1.w + wall1.x - 50 &&
    heli.y + heli.h >= wall1.y + wall1.h - 50
  ) {
    gameOver();
  } else if (
    heli.x + heli.w >= wall2.x + wall2.w - 50 &&
    heli.y + heli.h >= wall2.y + wall2.h - 50
  ) {
    gameOver();
  } else if (
    heli.x + heli.w >= wall3.x + wall3.w - 50 &&
    heli.y + heli.h >= wall3.y + wall3.h - 50
  ) {
    gameOver();
  }
}
